...
return (
    <Router>
      <div className="text-center">
        ...
        <p className="text-lg text-gray-600 mb-6">You deserve this break.
You’ve worked hard, pushed through stress, deadlines, and daily grind now it’s time to breathe.</p>

        <Routes>
          <Route path="/" element={<Home />} /> 
          <Route path="/destinations" element={<DestinationsList destinations={destinations} />} />
          <Route path="/destination/:name" element={<DestinationDetails destinations={destinations} />} />
